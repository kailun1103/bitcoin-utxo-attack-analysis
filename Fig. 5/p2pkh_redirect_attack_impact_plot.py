...
BOX_COLORS = ["#8BA8D8", "#C5FBD1", "#EECACB", "#D8D1F3"]
# Darken factor
dark_factor = 0.5
...
def main():
    # Read CSV
    df = pd.read_csv('data/p2wpkh.csv')

    # Columns and labels
    columns = [
        'P2WPKH_P2SH-P2WPKH_matches',
        'P2WPKH_P2WSH_matches',
        'P2WPKH_P2TR_script_path_matches',
        'P2WPKH_P2PKH_matches'
    ]
    labels = [
        'P2WPKH to\nP2SH-P2WPKH',
        'P2WPKH to\nP2WSH',
    ...
    ax.set_title('Dust UTXO Attack Impact - P2WPKH Redirect Attack', fontsize=24, pad=25)
    ...
    # Save and show
    plt.savefig('p2pkh_redirect_attack_impact_plot.png', dpi=600)
    plt.show()
