...
Reads pre-computed category_id from JSON files and generates a CDF plot.
Supports configurable font sizes and a single legend at the bottom.
"""
...
# ───────── Configuration ─────────────────────────────────────────────
ADDR = "P2SH"  # Target address type
INPUT_PATH = "P2SH_utxos.json"  # Input file or folder
OUTPUT_PATH = INPUT_PATH.replace(".json", "_cdf_plot.png")
CHUNK_SIZE = 20
DUST_TH = 546
MIN_CNT = 1

# Y-axis range and tick spacing
Y_AXIS_MIN = 0
Y_AXIS_MAX = 700
Y_TICK_STEP = 100
        ...
        if cat == 1:
            ...
            for n, blist in sorted(sigs_map.items()):
                if blist:
                    ...
                    ax.text(20, y_med, f"{n} sigs", va="center", ha="left",
