...
for P2WSH script types, grouped by smart contract categories.
"""
...
# ───────── Configuration ─────────────────────────────────────────────
ADDR = "P2WSH"  # Target address type
INPUT_PATH = "P2WSH_utxos.json"
...
def plot_and_stats(cat_map):
    ...
    for idx, cat in enumerate(cats):
        ...
        ax.axhline(y=43, color="green", linestyle="-.", linewidth=2,
                   label="Locked UTXO (43 bytes)", zorder=3)
